...
/*
 * Which, inserted independently at line 5, will compile? (Choose all that
 * apply.) A. b = (Number instanceof s); B. b = (s instanceof Short); C. b =
 * s.instanceof(Short); D. b = (s instanceof Number); E. b =
