...
public class TreeSetImpl<E> {
	...
	public NavigableSet<E> subSet(E fromElement, boolean fromInclusive,
		...
		return treeSet.subSet(fromElement, fromInclusive, toElement,
				toInclusive);
	}
	...
	public static void main(String... arg) {
		...
		System.out.println("the ceiling of -100 in the TreeSet is "
				+ treeSet.ceiling(-100));
		...
		System.out.println("the lowest element in the set is "
				+ treeSet.first());
		System.out
				.println("the floor of 20 in treeSet is " + treeSet.floor(20));
